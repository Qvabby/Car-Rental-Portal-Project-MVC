...
namespace Car_Rental_Portal_Project_MVC.Migrations
{
    ...
    [Migration("20230721120215_RentOrderModelChange2")]
    partial class RentOrderModelChange2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Car_Rental_Portal_Project_MVC.Models.RentOrder", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ApplicationCarId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Car_Rental_Portal_Project_MVC.Models.RentOrder", b =>
                {
                    b.HasOne("Car_Rental_Portal_Project_MVC.Models.ApplicationCar", "ApplicationCar")
                        .WithMany()
                        .HasForeignKey("ApplicationCarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
